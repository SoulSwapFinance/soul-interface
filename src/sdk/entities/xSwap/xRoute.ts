...
export class xRoute<TInput extends Currency, TOutput extends Currency> {
  public readonly pairs: xPair[]
  public readonly path: xToken[]
  public readonly input: TInput
  public readonly output: TOutput

  public constructor(pairs: xPair[], input: TInput, output: TOutput) {
    ...
    const path: xToken[] = [wrappedInput]
  ...
  private _midPrice: xPrice<TInput, TOutput> | null = null

  public get midPrice(): xPrice<TInput, TOutput> {
    if (this._midPrice !== null) return this._midPrice
    const prices: xPrice<Currency, Currency>[] = []
    ...
    return (this._midPrice = new xPrice(
      this.input,
      this.output,
      reduced.denominator,
      reduced.numerator
