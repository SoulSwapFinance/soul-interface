import { Currency, CurrencyAmount, MultiRoute, RToken, Percent, Price, TradeType, ZERO, JSBI, Fraction, ONE } from 'sdk'
 ...
 */
export class TridentTrade<TInput extends Currency, TOutput extends Currency, TTradeType extends TradeType> {
  /**
  ...
  public static exactIn<TInput extends Currency, TOutput extends Currency>(
    route: MultiRoute
  ): TridentTrade<TInput, TOutput, TradeType.EXACT_INPUT> {
    return new TridentTrade(route, TradeType.EXACT_INPUT)
  }
  ...
  public static exactOut<TInput extends Currency, TOutput extends Currency>(
    route: MultiRoute
  ): TridentTrade<TInput, TOutput, TradeType.EXACT_OUTPUT> {
    return new TridentTrade(route, TradeType.EXACT_OUTPUT)
  }
