...
import {
  ...
  import { UnderworldMediumRiskLendingPair } from '../entities'
...
export function accrue(pair: UnderworldMediumRiskLendingPair, amount: JSBI, includePrincipal = false): JSBI {
    return JSBI.add(
      JSBI.divide(
  ...
  export function accrueTotalAssetWithFee(pair: UnderworldMediumRiskLendingPair): {
    elastic: JSBI
    base: JSBI
  } {
  ...
  export function interestAccrue(pair: UnderworldMediumRiskLendingPair, interest: JSBI): JSBI {
