...
export interface TradeOptions {
  ...
  // whether transaction is crosschain
...
// represents: SoulSwap Router, and has static methods for helping execute trades.
...
// represents: TraderJoe Router, and has static methods for helping execute trades.
export abstract class TraderJoeRouter {
  /**
   * Cannot be constructed.
   */
  private constructor() {}
