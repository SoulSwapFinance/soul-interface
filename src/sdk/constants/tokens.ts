import { FTM_ADDRESS, USDC_ADDRESS, CHANT_ADDRESS, DAI_ADDRESS, WETH9_ADDRESS, WNATIVE_ADDRESS, SOUL_ADDRESS, LZ_USDC_ADDRESS, MULTI_USDC_ADDRESS } from './addresses'
