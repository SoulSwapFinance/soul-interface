...
export const SEANCE_ADDRESS: { [chainId in ChainId]: string } = {
  ...
  [ChainId.FANTOM_TESTNET]: '',
  [ChainId.AVALANCHE]: '0xB641880C65A33605fc5a4F8b955a868a98D4a58e',
  [ChainId.MATIC]: '',
  [ChainId.MOONRIVER]: '',
  [ChainId.ARBITRUM]: '',
}
...
export const SUMMONER_ADDRESS: { [chainId in ChainId]: string } = {
  ...
  [ChainId.FANTOM_TESTNET]: '',
  [ChainId.AVALANCHE]: '0x9961c13913bC8Aa6e0D9c32765dC7886550603af',
  [ChainId.MATIC]: '',
  [ChainId.MOONRIVER]: '',
  [ChainId.ARBITRUM]: '',
}
...
export const AUTO_STAKE_ADDRESS: { [chainId in ChainId]: string } = {
  ...
  [ChainId.FANTOM_TESTNET]: '',
  [ChainId.AVALANCHE]: '0x5b017074947f18fC86F161fE254BC76225783625',
  [ChainId.MATIC]: '',
  [ChainId.MOONRIVER]: '',
  [ChainId.ARBITRUM]: '',
}
...
export const SOUL_NATIVE_ADDRESS: { [chainId in ChainId]: string } = {
  [ChainId.ETHEREUM]: '',
  [ChainId.TELOS]: '',
  [ChainId.BSC]: '',
  [ChainId.FANTOM]: '0xa2527Af9DABf3E3B4979d7E0493b5e2C6e63dC57',
  [ChainId.FANTOM_TESTNET]: '',
  [ChainId.AVALANCHE]: '0x6Da1AD717C7577AAB46C19aB6d3d9C31aff32A00',
  [ChainId.MATIC]: '',
  [ChainId.MOONRIVER]: '',
  [ChainId.ARBITRUM]: '',
}
...
export const WETH_ADDRESS: AddressMap = {
  ...
  [ChainId.FANTOM_TESTNET]: '0x442993b05D170AE47af948FBF507B9972f26cA86',
  [ChainId.BSC]: '',
  [ChainId.MATIC]: '',
