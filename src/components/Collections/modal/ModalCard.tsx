...
import Steps from 'components/NFT/Steps'
import { Execute } from 'nfnt-client-sdk/dist/types/index'
import FormatEth from 'components/NFT/format/FormatEth'
// import Link from 'next/link'

const SOURCE_ID = process.env.NEXT_PUBLIC_SOURCE_ID
const DARK_MODE = process.env.NEXT_PUBLIC_DARK_MODE
const DISABLE_POWERED_BY_SOUL =
  process.env.NEXT_PUBLIC_DISABLE_POWERED_BY_SOUL
        ...
        <div className="px-5">
          <div
            className={`mx-auto overflow-hidden border border-neutral-300 bg-white p-11 shadow-xl dark:border-neutral-600 dark:bg-black md:w-[510px] ${
              DISABLE_POWERED_BY_SOUL ? ' rounded-2xl' : ' rounded-t-2xl'
            }`}
          >
