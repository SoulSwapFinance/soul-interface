...
import FullScreenOff from 'assets/svg/fullscreen_off.svg'
import FullScreenOn from 'assets/svg/fullscreen_on.svg'
import AnimatedLoader from 'components/Loader/AnimatedLoader'
import { Z_INDEXS } from 'constants/styles'
import useTheme from 'hooks/useTheme'
// import { useUserLocale } from 'state/user/hooks'

import { ChartingLibraryWidgetOptions, LanguageCode, ResolutionString, Timezone } from './library'
...
function ProLiveChart({
  ...
  }, [theme, ref, pairAddress, currencies, hasProChart]) // userLocale
