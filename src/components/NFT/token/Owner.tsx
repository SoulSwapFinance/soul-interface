  ...
  return (
    <div className="col-span-full md:col-span-4 lg:col-span-5 lg:col-start-2">
      <article className="col-span-full rounded-2xl border border-gray-300 bg-white p-6 dark:border-neutral-600 dark:bg-black">
        <div className="soulswap-h3 mb-6 flex items-center gap-4 overflow-hidden font-headings dark:text-white">
        ...
        {/* {token?.token?.kind === 'erc1155' && (
          <div className="mb-4 flex justify-evenly">
            <div className="flex items-center gap-2">
              ...
              <span className="soulswap-h5 ">Owners</span>
            </div>
            <div className="flex items-center gap-2">
              <FiDatabase className="h-4 w-4" />
              <span className="soulswap-h5 ">Total</span>
            </div>
          </div>
        )} */}

        <div className="soulswap-h6 mb-2 font-headings dark:text-white">
          Owner
        </div>
        {owner && (
