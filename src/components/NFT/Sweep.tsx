import { Execute, paths, ReservoirSDK } from 'nfnt-client-sdk'
import React, {
  ComponentProps,
  FC,
  useContext,
...
import AttributesFlex from './attribute/AttributesFlex'
...
const Sweep: FC<Props> = ({ tokens, collection, mutate, setToast }) => {
  ...
  const isInTheWrongNetwork = Boolean(
    signer && CHAIN_ID && chainId !== +CHAIN_ID
  )
                ...
                <div className="px-5">
                  ...
                  >
                    ...
                    <div className="mb-4 flex justify-between">
                      <div className="nfnt-h6 text-center dark:text-white">
                        Total Price
                      </div>
                      <div className="nfnt-h5 text-center dark:text-white">
                        <FormatEth
                          amount={sweepTotal}
                          maximumFractionDigits={4}
                          logoWidth={7}
                  ...
                  {!DISABLE_POWERED_BY_SOULSWAP && (
                    <div className="mx-auto flex items-center justify-center rounded-b-2xl bg-neutral-100 py-4 dark:bg-neutral-800 md:w-[639px]">
                      <Link href="https://reservoirprotocol.github.io/">
                        <a
                          className="reservoir-tiny flex gap-2 text-lg dark:text-white"
                          target="_blank"
                        >
                          Powered by{' '}
                          <Image
