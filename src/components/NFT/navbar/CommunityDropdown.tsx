...
const CommunityDropdown: FC<Props> = ({ collections, defaultCollectionId }) => {
  ...
  return (
    <DropdownMenu.Root open={open} onOpenChange={setOpen}>
      <DropdownMenu.Trigger className="nfnt-h6 rounded dark:text-white dark:outline-none dark:ring-primary-900 dark:focus:ring-4">
        Collections
        <FiChevronDown
        ...
        {collections
          ...
          .map((collection) => {
            return (
              ...
              >
                <Link href={`/nft/collections/${collection.collectionId}`}>
                  <a
                    onClick={() => {
                      setOpen(false)
                    }}
                  ...
                  >
                    ...
                    />
                    <p className="nfnt-h6 truncate dark:text-white">
                      {collection.name}
                    </p>
                  </a>
                </Link>
