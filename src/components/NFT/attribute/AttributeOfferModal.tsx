...
type Props = {
  ...
  // signer: ReturnType<typeof getSigner>['data']
...
const AttributeOfferModal: FC<Props> = ({
  ...
  const isInTheWrongNetwork = Boolean(signer && chainId !== env.chainId)
  ...
  useEffect(() => {
    ...
    if (weth?.balance && ethBalance) {
      const calculations = calculateOffer(
        userInput,
        ethBalance.toString().toBigNumber(18),
        weth.balance,
        bps
      )
            ...
            <>
              <div className="mb-8 space-y-5">
                <div className="flex items-center justify-between">
                  <label
                    htmlFor="price"
                    className="nfnt-h6 font-headings dark:text-white"
                  >
                    Price (wETH)
                  </label>
                  <input
                ...
                <div className="flex justify-between">
                  <div className="nfnt-h6 font-headings dark:text-white">
                    Fees
                  </div>
                ...
                <div className="flex justify-between">
                  ...
                  <div className="nfnt-h6 font-headings font-bold dark:text-white">
