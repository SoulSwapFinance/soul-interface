...
const AssetInputPanel = ({
  ...
  const nativePrice = useTokenPrice(WNATIVE_ADDRESS[chainId ?? ChainId.FANTOM])
  const ftmPrice = useTokenPrice(WNATIVE_ADDRESS[chainId ?? ChainId.FANTOM])
  // const nativePrice = Number(usePriceUSD(WNATIVE_ADDRESS[chainId ?? ChainId.FANTOM]).price)
  const btcPrice = useTokenPrice(WBTC_ADDRESS[chainId ?? ChainId.FANTOM])
  const ethPrice = useTokenPrice(WETH_ADDRESS[chainId ?? ChainId.FANTOM])
  // console.log('ethPrice: :%s', ethPrice)
  const bnbPrice = useTokenPrice(BNB_ADDRESS[chainId ?? ChainId.FANTOM])
