    ...
    <div className="px-3 py-3 mx-auto max-w-7xl sm:px-6 lg:px-8">
      <div className="pr-16 sm:text-center sm:px-16">
        <p className="font-medium text-white">
          <span className="centered md:hidden">Grim Withdrawals Available.
          <a href="https://app.grim.finance/" target = "_blank" rel="noreferrer"
              className="font-bold text-white underline">
              {' '}
              <br />
              Click to Withdraw <span aria-hidden="true">&rarr;</span>
            </a>
            </span>
          <span className="hidden md:inline"> Grim Withdrawals Available.</span>
          <br/>
