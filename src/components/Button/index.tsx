...
export type ButtonColor = 'blue' | 'ftmBlue' | 'avaxRed' | 'ethBlue' | 'btcOrange' | 'usdcBlue' | 'binanceGold' | 'moonriverTeal' | 'maticPurple' | 'arbitrumBlue' | 'pink' | 'purple' | 'gradient' | 'gray' | 'default' | 'red' | 'green' | 'yellow'
