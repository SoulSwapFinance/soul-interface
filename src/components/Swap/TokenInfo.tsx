...
import { formatLongNumber } from 'utils/currency/formatBalance'
...
const TokenInfo = ({ currencies, onBack }: { currencies: { [field in Field]?: Currency }; onBack?: () => void }) => {
  ...
  const listData = [
    { label: 'Price', value: tokenInfo.price ? formatNumber(tokenInfo.price.toString(), true) : NOT_AVAIALBLE },
    {
    ...
    },
    {
      ...
      value: tokenInfo.marketCapRank ? `#${formatNumber(tokenInfo.marketCapRank.toString())}` : NOT_AVAIALBLE,
    },
    {
      label: 'Market Cap',
    ...
    {
      label: 'All-Time High',
      value: tokenInfo.allTimeHigh ? formatNumber(tokenInfo.allTimeHigh.toString(), true) : NOT_AVAIALBLE,
    },
    {
      label: 'All-Time Low',
      value: tokenInfo.allTimeLow ? formatNumber(tokenInfo.allTimeLow.toString(), true) : NOT_AVAIALBLE,
    },
    {
