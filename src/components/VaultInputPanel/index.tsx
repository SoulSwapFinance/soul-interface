...
interface VaultInputPanelProps {
  value?: string
...
export default function VaultInputPanel({
  value,
  onUserInput,
  onMax,
  // showMaxButton,
  ...
  return (
    <div id={id} className={classNames(hideInput ? 'p-4' : 'p-5', 'rounded bg-dark-1000 border border-dark-700 border hover:border-purple')}>
