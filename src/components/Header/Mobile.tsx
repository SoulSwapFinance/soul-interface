...
const Mobile: FC = () => {
  ...
  return (
    <>      
      <header className="w-full bg-dark-1000 flex items-center text-white mt-2 text-center justify-center min-h-[36px] h-[36px] px-0 sm:px-2">
      <div className="flex justify-between flex-grow">
      <div className="p-2 rounded-full hover:bg-white/10">
        {/* <div className="flex p-2 justify-between"> */}
            <MenuIcon width={25} className="hover:text-white text-white cursor-pointer" onClick={() => setOpen(true)} />
            </div>
