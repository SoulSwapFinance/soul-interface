import { Token, CurrencyAmount, Currency } from 'sdk'
import { useMemo } from 'react'
// import { useAllTokenBalances } from '../../state/wallet/hooks'
import { useBridgeAllTokenBalances } from 'state/wallet/bridge'

// compare two token amounts with highest one coming first
function balanceComparator(balanceA?: CurrencyAmount<Currency>, balanceB?: CurrencyAmount<Currency>, sortA?:any, sortB?:any) {
  if (sortA > sortB) {
    return 1
  } else {
