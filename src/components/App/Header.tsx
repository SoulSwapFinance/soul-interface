...
import { Select } from 'components/CrossSwap/Select'
        ...
        <div className="flex items-center gap-3">
          <a className="flex flex-row items-center gap-1.5" href="/">
            <div className="w-6 h-6">
              {/* <SoulIcon width="100%" height="100%" className="mr-2 hover:animate-heartbeat" /> */}
            </div>
          </a>
            ...
            <Select.Options className="w-[max-content] !bg-slate-700 -ml-5 mt-5 !max-h-[unset]">
              <div className="grid grid-cols-1 gap-1 px-2 py-2 md:grid-cols-3">
                <div>
                  ...
                  <Select.Option
                    as="a"
                    // href="https://soul.sh/earn"
                    href="https://soul.sh/farm"
                    key={AppType.Invest}
                ...
                <div>
                  ...
                  {/* <Select.Option
                    as="a"
                    href="https://soul.sh/underworld"
                    key={AppType.Underworld}
                    value={AppType.Underworld}
                    className="!border-slate-700 !cursor-pointer px-2 flex flex-col gap-0 !items-start group"
                  >
                    Underworld
                    <Typography variant="xs" className="text-slate-400 group-hover:text-blue-100">
                  ...
                  <Select.Option
                    as="a"
                    href="https://pay.soulswap.finance"
                    key={AppType.Furo}
                    value={AppType.Furo}
                    className="!border-slate-700 !cursor-pointer px-2 flex flex-col gap-0 !items-start group"
                  >
                ...
                <div>
                  ...
                  <Select.Option
                    as="a"
                    href="https://soulswapfinance.medium.com"
                    key={AppType.Blog}
                    value={AppType.Blog}
                    className="!border-slate-700 !cursor-pointer px-2 flex flex-col gap-0 !items-start group"
                  >
