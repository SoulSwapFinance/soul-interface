...
export default function CurrencyInputPanelV2({
  value,
  error,
  onUserInput,
  onMax,
  ...
  const selectedCurrencyBalance = useCurrencyBalance(chainId, account, currency ?? undefined)
                  ...
                  <RowFixed>
                    ...
                    >
                      {(nativeCurrency?.symbol && maxCurrencySymbolLength
                        ? shortenAddress(nativeCurrency.symbol, maxCurrencySymbolLength)
                        : nativeCurrency?.symbol) ||
                        loadingText || `Select Token`}
                    </StyledTokenName>
                  </RowFixed>
