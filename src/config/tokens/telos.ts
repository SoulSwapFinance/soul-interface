...
export const USDT = new Token(ChainId.TELOS, '0xeFAeeE334F0Fd1712f9a8cc375f427D9Cdd40d73', 6, 'USDT', 'Tether USD')
export const SOUL = new Token(ChainId.TELOS, '0xef9777827a3581b64f5c7CB8954ccaE3cc2c46C0', 18, 'SOUL', 'Soul Power')