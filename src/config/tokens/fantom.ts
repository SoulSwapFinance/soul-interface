...
// todo
// export const USDC = new Token(ChainId.FANTOM, '0x28a92dde19D9989F39A49905d7C9C2FAc7799bDf', 6, 'USDC', 'USD Coin')
...
export const AXLUSDC = new Token(ChainId.FANTOM, '0x1B6382DBDEa11d97f24495C9A90b7c88469134a4', 6, 'axlUSDC', 'USDC (Axelar)')
export const WBTC = new Token(ChainId.FANTOM, '0x321162Cd933E2Be498Cd2267a90534A804051b11', 8, 'WBTC', 'Wrapped Bitcoin')
