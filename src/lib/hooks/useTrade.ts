...
// import { useCoffinBoxTotal } from 'hooks/useCoffinBox/useCoffinBoxTotals'
import { useCurrencyCombinations } from 'hooks/useCurrencyCombinations'
...
//   const currencyInAmount = Number(useUserTokenInfo(COFFIN_BOX_ADDRESS[chainId], currencyIn.wrapped.address).userTokenInfo.balance)
//   let currencyInRebase = { base: JSBI.BigInt(currencyInAmount), elastic: JSBI.BigInt(currencyInAmount) }
//   const currencyOutAmount = Number(useUserTokenInfo(COFFIN_BOX_ADDRESS[chainId], currencyOut.wrapped.address).userTokenInfo.balance)
//   // let currencyAmountOut = JSBI
//   let currencyOutRebase = { base: JSBI.BigInt(currencyOutAmount), elastic: JSBI.BigInt(currencyOutAmount) }
...
//         //   const useLegacy = CurrencyAmount.fromRawAmount(currencyOut.wrapped, legacyRoute.amountOutBN.toString()).greaterThan(
//         //     CurrencyAmount.fromShare(currencyOut.wrapped, tridentRoute.amountOutBN.toString(), currencyOutRebase)
//         //   )
...
//         //   currencyIn.wrapped,
//         //   currencyOut.wrapped,
//         //   BigNumber.from(amountSpecified.toShare(
//         //     currencyInRebase).quotient.toString()),
//         //   [
//         //     // ...filteredPools.filter((pool): pool is ConstantProductPool => pool instanceof ConstantProductPool),
//         //     // ...filteredPools.filter((pool): pool is StablePool => pool instanceof StablePool),
//         //   ],
