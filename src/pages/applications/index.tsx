...
export default function Applications() {
  ...
  const toggleMinesModal = useToggleModal(ApplicationModal.MINES)
  const toggleSeanceModal = useToggleModal(ApplicationModal.SEANCE)
  const toggleBondsModal = useToggleModal(ApplicationModal.BONDS)
