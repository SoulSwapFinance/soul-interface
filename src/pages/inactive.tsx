    ...
    <>
      ...
      <DoubleGlowShadowV2 opacity="0.6">
        <div className="w-full max-w-2xl p-4 rounded z-1">
          <QuickLinks route="/circles" text="Circles pool" />
          <QuickLinks route="/enchant" text="Enchant staking" />
          <QuickLinks route="/exchange/remove/ETH/0x6a1a8368D607c7a808F7BbA4F7aEd1D9EbDE147a" text="Remove FTM-Enchant LP" />
        </div>
      </DoubleGlowShadowV2>
    {/* </div> */}
    </>
