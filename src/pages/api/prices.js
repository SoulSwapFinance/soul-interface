...
const NETWORK_URL = 'https://rpc.fantom.tools' // todo
const web3 = new Web3(NETWORK_URL)

export default async function handler(req, res) {
  let ftmUSDCContract = new web3.eth.Contract(IUniswapV2PairABI, '0x160653F02b6597E7Db00BA8cA826cf43D2f39556')
  ...
  let soulFtmContract = new web3.eth.Contract(IUniswapV2PairABI, '0xa2527Af9DABf3E3B4979d7E0493b5e2C6e63dC57')
  ...
  const seanceFtmReserves = await ribMovrContract.methods.getReserves().call()
