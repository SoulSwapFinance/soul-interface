...
export default function Dashboard() {
  ...
  return (
    <Container id="dashboard-page" className="py-4 space-y-4 md:py-8 max-w-min">
      ...
      <div className="py-1 mb-1 mt-3 ml-2 mr-2 bg-dark-600" />
        <div className="py-1 mb-1 ml-2 mr-2  bg-purple" />
        <Typography variant="h1" className="text-center mt-4 mb-4 text-dark-600" component="h1">
          SOULSWAP FINANCE
        </Typography>
        <div className="py-1 mt-1 ml-2 mr-2 bg-dark-600" />
        <div className="py-1 mt-1 ml-2 mr-2 mb-3 bg-purple" />
