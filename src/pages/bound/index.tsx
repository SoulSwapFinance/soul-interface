    ...
    <Container id="bound-page" className="py-4 md:py-8 lg:py-12" maxWidth="full">
      <Head>
        ...
        <meta
          ...
          content="Stake SOUL in return for SPELL, an interest bearing and fungible ERC20 token designed to share revenue generated by all SOUL products."
        />
        <meta key="twitter:image" name="twitter:image" content="https://app.soulswap.finance/spell-sign.png" />
        ...
        <meta key="og:image" property="og:image" content="https://app.soulswap.finance/spell-sign.png" />
        <meta
          key="og:description"
      ...
      <div className="flex flex-col w-full min-h-full">
        <div className="flex justify-center mb-6">
          ...
          <div className="hidden px-8 ml-6 md:block w-72">
            <Image src="/spell-sign.png" alt="SPELL sign" width="100%" height="100%" layout="responsive" />
          </div>
        </div>
                ...
                <div className="flex flex-col flex-grow md:mb-14">
                  ...
                  <div className="flex items-center space-x-4">
                    <Image
                      ...
                      src="/images/tokens/spell-square.jpg"
                      alt="SPELL"
                      width={64}
                      height={64}
                    />
