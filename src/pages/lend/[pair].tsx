...
import { Deposit, PairTools, Strategy, Withdraw } from 'features/underworld'
import { useKashiPair } from 'features/underworld/hooks'
    ...
    <PairLayout>
      ...
      <Card
        ...
        //   <Card.Header className="border-b-8 bg-dark-blue border-blue">
          <Card className="border-b-8 bg-dark-blue border-blue">
