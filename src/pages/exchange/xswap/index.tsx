...
import chains, { Chain } from 'constants/xchains'
import { ChainId } from 'sdk'
import {Currency, CurrencyAmount,  NATIVE, Percent, Price, ZERO, JSBI, TradeType, COFFIN_BOX_ADDRESS } from 'sdk'
...
// } from 'components/CrossSwap/components'
...
//               <App.NavItem href="https://exchange.soulswap.finance/xswap" label="xSwap" />
//             </App.NavItemList>
...
//                                       fullWidth
//                                       amount={srcAmount}
//                                       address={COFFIN_BOX_ADDRESS[srcChainId]}
//                                     />
//                                   </Approve.Components>
//                                 }
//                                 render={({ approved }) => {
