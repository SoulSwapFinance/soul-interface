import { Currency, CurrencyAmount, Token, Trade, TradeType } from 'sdk'
...
import { ClickableText } from 'components/ReusableStyles'
...
import { ArrowWrapper, BottomGrouping, Dots, Wrapper } from 'features/swap/styleds'
...
//   const [allowedSlippage] = useUserSlippageTolerance()
  ...
  const { v2Trade, currencyBalances, parsedAmount, currencies, inputError: swapInputError, allowedSlippage} = useDerivedSwapInfo()
  const {
    wrapType,
    execute: onWrap,
  ...
  const userHasSpecifiedInputOutput = Boolean(
    currencies[Field.INPUT] && currencies[Field.OUTPUT] && parsedAmounts[independentField]?.greaterThan(0),
  )
  const noRoute = !route
  ...
  return (
    <>
      ...
      <Container>
        ...
        <RowBetween mb={'16px'}>
          <TYPE.Black color={'black'} fontSize={20} fontWeight={500}>{t`Swap`}</TYPE.Black>
          <TransactionSettings />
        </RowBetween>
        ...
        <Wrapper id="swap-page">
            ...
            {showWrap ? null : (
              ...
              >
                <AutoColumn gap="4px">
                  ...
                  {Number(allowedSlippage) !== INITIAL_ALLOWED_SLIPPAGE && (
                    <div style={{ alignItems: 'center', display: 'flex' }}>
                      <ClickableText fontWeight={500} fontSize={14} color={'white'} onClick={toggleSettings}>
          ...
          <BottomGrouping>
            {!account ? (
              ...
              <Card style={{ textAlign: 'center', borderRadius: '5.5px' }}>
                <TYPE.Main mb="4px">
                  <Dots>
