...
export const setLimitOrderCoffinPermit = createAction<Signature | undefined>('limit-order/setLimitCoffinPermit')
...
export const setFromCoffinBalance = createAction<boolean>('limit-order/setFromCoffinBalance')
