...
export enum TRANSACTION_TYPE {
  ...
  SOULPOWER_STAKE = 'SoulPower Stake',
  SOULPOWER_UNSTAKE = 'SoulPower Unstake',
  SOULPOWER_DELEGATE = 'SoulPower Delegate',
  SOULPOWER_UNDELEGATE = 'SoulPower Undelegate',
  SOULPOWER_MIGRATE = 'SoulPower Migrate',
  SOULPOWER_VOTE = 'SoulPower Vote',
  SOULPOWER_CLAIM = 'SoulPower Claim Voting Reward',
  SOULPOWER_CLAIM_GAS_REFUND = 'Gas Refund',
...
export const GROUP_TRANSACTION_BY_TYPE = {
  ...
  SOULPOWER: [
    TRANSACTION_TYPE.SOULPOWER_STAKE,
    TRANSACTION_TYPE.SOULPOWER_UNSTAKE,
    TRANSACTION_TYPE.SOULPOWER_DELEGATE,
    TRANSACTION_TYPE.SOULPOWER_UNDELEGATE,
    TRANSACTION_TYPE.SOULPOWER_MIGRATE,
    TRANSACTION_TYPE.SOULPOWER_VOTE,
    TRANSACTION_TYPE.SOULPOWER_CLAIM,
    TRANSACTION_TYPE.SOULPOWER_CLAIM_GAS_REFUND,
  ],
  OTHER: [
