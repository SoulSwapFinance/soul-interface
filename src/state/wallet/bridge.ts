...
export function useBridgeAllTokenBalances(key?: string | undefined, chainId?:any): { [tokenAddress: string]: CurrencyAmount<Currency> | undefined } {
  ...
  export function useBridgeAllTokensBalances(chainId?:any): { [tokenAddress: string]: CurrencyAmount<Currency> | undefined } {
    const { account } = useActiveWeb3React()
