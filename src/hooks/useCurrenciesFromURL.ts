import { Currency, NATIVE, SOUL_SUMMONER_ADDRESS } from 'sdk'
import { Fee } from 'sdk'
...
const useCurrenciesFromURL = (): {
  ...
  const currencyB = useCurrency(router.query.tokens?.[1]) || (chainId && SOUL_SUMMONER_ADDRESS[chainId]) || undefined
