...
// }
const backgrounds = {
  dashboard: '/images/analytics/analytics-background-token.svg',
  bar: '/images/analytics/analytics-background-token.svg',
  farms: '/images/analytics/analytics-background-token.svg',
  pool: '/images/analytics/analytics-background-token.svg',
  pools: '/images/analytics/analytics-background-token.svg',
  token: '/images/analytics/analytics-background-token.svg',
  tokens: '/images/analytics/analytics-background-token.svg',
}
