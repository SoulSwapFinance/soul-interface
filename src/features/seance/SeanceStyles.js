...
export const SeanceContainer = styled.div`
  display: grid;
...
export const SeanceContentWrapper = styled.div`
  display: flex;
...
export const SeanceItemBox = styled.div`
...
export const SeanceItemHeading = styled.p`
  font-weight: normal;
  font-size: 0.8rem;
  color: white;
  align-items: center;
...
export const SeanceItem = styled.h2`
  font-size: 1.5rem;
  color: white;
`
...
export const SubmitButton = styled.button`
  ...
  padding: 0.25em;
  transition: all 0.2s ease-in-out;
  background: ${({ primaryColour }) => (primaryColour ? primaryColour : '#DCB2FF')};
