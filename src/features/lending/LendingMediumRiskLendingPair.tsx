...
import { accrue, AccrueInfo, interestAccrue, takeFee } from 'sdk'
import { computeUnderworldPairAddress } from 'state/user/hooks'

import { accrueTotalAssetWithFee } from './functions'
import { Oracle } from './oracles'

export class LendingMediumRiskLendingPair {
  ...
  public static getAddress(collateral: Token, asset: Token, oracle: string, oracleData: string): string {
    return computeUnderworldPairAddress({
      collateral,
      asset,
      oracle,
      oracleData,
...
export default LendingMediumRiskLendingPair