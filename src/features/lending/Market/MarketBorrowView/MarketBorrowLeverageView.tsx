...
import { useMarket, useLiquidationPrice } from 'features/lending/Market'
...
interface MarketBorrowLeverageView {
...
export const MarketBorrowLeverageView: FC<MarketBorrowLeverageView> = ({
  borrowAmount,
  collateralAmount,
  enabled,
  onSwitch,
