...
import SubmittedModalContent from 'components/Modal/SubmittedModalContent'
import Typography from 'components/Typography'
import { MarketDetailsView, useBorrowExecute, useMarket } from 'features/lending/Market'
import { MarketBorrowButtonProps } from 'features/lending/Market/MarketBorrowView/MarketBorrowButton'
import { useV2TradeExactIn } from 'hooks/useV2Trades'
import React, { FC, useCallback, useState } from 'react'
import { useActiveWeb3React } from 'services/web3'

interface MarketBorrowReviewModal
  extends Omit<MarketBorrowButtonProps, 'nextMaxBorrowMinimum' | 'nextMaxBorrowSafe' | 'nextMaxBorrowPossible'> {
  open: boolean
  onDismiss(): void
  permit?: Signature
}

export const MarketBorrowReviewModal: FC<MarketBorrowReviewModal> = ({
  spendFromWallet,
  receiveInWallet,
  permit,
  leveraged,
