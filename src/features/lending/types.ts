...
export type CoffinBalance = BigNumber

export type CoffinAllowance = BigNumber

export type Nonce = BigNumber

export type CoffinAmount = BigNumber

export type CoffinShare = BigNumber
...
export interface Collateral {
  ...
  coffinAllowance: CoffinAllowance
  nonce: Nonce
  coffinAmount: CoffinAmount
  coffinShare: CoffinShare
  rate: Rate
  address: string
  elastic: Elastic
  base: Base
...
export type CoffinBalance2 = BigNumber

export type CoffinAllowance2 = BigNumber

export type Nonce2 = BigNumber

export type CoffinAmount2 = BigNumber

export type CoffinShare2 = BigNumber
...
export interface Asset {
  ...
  balance: Balance2
  coffinBalance: CoffinBalance2
  coffinAllowance: CoffinAllowance2
  nonce: Nonce2
  coffinAmount: CoffinAmount2
  coffinShare: CoffinShare2
  rate: Rate2
  address: string
  elastic: Elastic2
  base: Base2
...
export interface UnderworldMarket {
