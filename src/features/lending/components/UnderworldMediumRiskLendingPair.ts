...
import { maximum, minimum, Rebase, toElastic, Token, ZERO } from 'sdk'
import JSBI from 'jsbi'
import {
  accrue,
  AccrueInfo,
  accrueTotalAssetWithFee,
  computeLendingPairAddress,
  interestAccrue,
  takeFee,
} from 'sdk'
...
export class UnderworldMediumRiskLendingPair {
  ...
  public constructor({
    ...
    this.address = UnderworldMediumRiskLendingPair.getAddress(collateral.token, asset.token, oracle.address, oracle.data)
...
export default UnderworldMediumRiskLendingPair
