...
import { classNames, currencyFormatter, formatNumber, formatPercent } from 'functions'
import { useUSDCSubgraphValueWithLoadingIndicator } from 'hooks/useUSDCSubgraph'
...
const UnderworldLendingListItem: FC<UnderworldLendingListItem> = ({ market }) => {
  ...
  return (
    <div
      ...
      onClick={() => router.push(`/lending/${market.address}`)}
    >
