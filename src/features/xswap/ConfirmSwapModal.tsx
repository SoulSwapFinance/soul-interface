...
function tradeMeaningfullyDiffers(
  ...args: [Trade<xCurrency, xCurrency, TradeType>, Trade<xCurrency, xCurrency, TradeType>]
): boolean {
...
export default function ConfirmSwapModal({
  ...
  isOpen: boolean
  trade: Trade<xCurrency, xCurrency, TradeType> | undefined
  originalTrade: Trade<xCurrency, xCurrency, TradeType> | undefined
