import { OpacityHoverState, ScrollBarStyles } from '../Common'
import Resource from '../Resource'
import { MouseoverTooltip } from 'components/Tooltip/index'
import { Box } from 'features/nft/components/Box'
import { reduceFilters } from 'features/nft/components/collection/Activity'
import { LoadingSparkle } from 'features/nft/components/common/Loading/LoadingSparkle'
import { AssetPriceDetails } from 'features/nft/components/details/AssetPriceDetails'
import { Center } from 'features/nft/components/Flex'
import { themeVars, vars } from 'features/nft/css/sprinkles.css'
import { ActivityFetcher } from 'features/nft/queries/genie/ActivityFetcher'
import { ActivityEventResponse, ActivityEventType, CollectionInfoForAsset, GenieAsset } from 'features/nft/types'
import { formatEthPrice } from 'features/nft/utils/currency'
import { isAudio } from 'features/nft/utils/isAudio'
import { isVideo } from 'features/nft/utils/isVideo'
import { putCommas } from 'features/nft/utils/putCommas'
import { fallbackProvider, getRarityProviderLogo } from 'features/nft/utils/rarity'
...
const AudioPlayer = ({
  ...
  return (
    ...
    >
      <Box as="audio" className={styles.audioControls} 
  ...
  const Filter = useCallback(
    function ActivityFilter({ eventType }: { eventType: ActivityEventType }) {
      ...
      return (
        <FilterBox
          backgroundColor={
            isActive ? (isDarkMode ? vars.color.gray500 : vars.color.gray200) 
            :
            vars.color.gray200
