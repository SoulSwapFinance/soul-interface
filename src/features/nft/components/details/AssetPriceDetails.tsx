...
import { useNftBalanceQuery } from 'services/graphql/data/nft/NftBalance'
import { CancelListingIcon, VerifiedIcon } from 'features//nft/components/icons'
import { useBag, useProfilePageState, useSellAsset } from 'features/nft/hooks'
import { CollectionInfoForAsset, GenieAsset, ProfilePageStateType, WalletAsset } from 'features/nft/types'
import {
        ...
        <OwnerInformationContainer>
          ...
          >
            {asset.tokenType === 'ERC1155' ? (
              ...
              <span> {isOwner ? 'You' : asset.owner.address && shortenAddress(asset.owner.address, 2)}</span>
            )}
          </OwnerText>
        </OwnerInformationContainer>
      )}
