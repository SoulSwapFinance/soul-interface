...
import { ethNumberStandardFormatter, formatWeiToDecimal, roundAndPluralize } from 'features/nft/utils'
...
export const MobileHoverBag = () => {
  ...
  return (
    <Row 
    // display={{ sm: shouldShowBag ? 'flex' : 'none', md: 'none' }} 
      ...
      >
        ...
        <Column>
          ...
          >
            ...
            <Box 
            // color="textSecondary" 
            className={bodySmall}>{`${ethNumberStandardFormatter(
              totalUsdPrice,
              true
            )}`}</Box>
          </Row>
